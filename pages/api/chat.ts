...
function buildSystemContext(data: UnifiedBusinessData): string {
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const { message, data, history = [] }: { message: string; data: UnifiedBusinessData; history: Message[] } = req.body;
